...
const pricingTiers = [
  ...
  },
  {
    ...
    badge: null,
    features: ["12 videos/month", "Up to 2 min per video/reel", "Voice recording + AI script", "YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "1 social platform (YouTube)"],
    cta: "Get Started",
    highlighted: false,
  ...
  },
  {
    ...
    badge: "Most Popular",
    features: ["16 videos/month", "Up to 2 min per video/reel", "Voice recording + AI script", "YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "Priority rendering", "1 social platform (YouTube)"],
    cta: "Get Started",
    highlighted: true,
