...
const pricingTiers = [
  {
    ...
    badge: null,
    features: ["4 short AI videos/month (up to 2 min each)", "Unlimited camera recordings (up to 15 mins each)", "Built-in teleprompter", "Voice recording + AI script", "AI content toolkit — title, script, description, tag & channel-name generators", "Thumbnail & YouTube channel banner generator","Long-form AI videos (8–10 min, mid-roll ad ready) — add credits anytime", "YouTube (16:9) & Reel (9:16) formats", "1 social platform (YouTube)", "Other platforms coming soon"],
    cta: "Get Started",
    highlighted: false,
  ...
  },
  {
    ...
    badge: "Most Popular",
    features: ["4 long-form AI videos/month (8–10 min, mid-roll ad ready)", "Plus 4 short AI videos/month (up to 2 min each)", "Unlimited camera recordings (up to 15 mins each)", "Built-in teleprompter", "Voice recording + AI script", "AI content toolkit — title, script, description, tag & channel-name generators", "Thumbnail & YouTube channel banner generator","YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "1 social platform (YouTube)", "Other platforms coming soon"],
    cta: "Get Started",
    highlighted: true,
  ...
  },
  {
    ...
    badge: null,
    features: ["8 long-form AI videos/month (8–10 min, mid-roll ad ready)", "Plus 4 short AI videos/month (up to 2 min each)", "Unlimited camera recordings (up to 15 mins each)", "Built-in teleprompter", "Voice recording + AI script", "AI content toolkit — title, script, description, tag & channel-name generators", "Thumbnail & YouTube channel banner generator","YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "Priority rendering", "1 social platform (YouTube)", "Other platforms coming soon"],
    cta: "Get Started",
    highlighted: false,
