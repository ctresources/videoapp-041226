...
const pricingTiers = [
  {
    ...
    badge: null,
    features: ["4 AI videos/month", "Unlimited camera recordings (up to 30 mins)", "Built-in teleprompter", "Up to 2 min per AI video/reel", "Voice recording + AI script", "YouTube (16:9) & Reel (9:16) formats", "1 social platform (YouTube)"],
    cta: "Get Started",
    highlighted: false,
  ...
  },
  {
    ...
    badge: "Most Popular",
    features: ["8 AI videos/month", "Unlimited camera recordings (up to 30 mins)", "Built-in teleprompter", "Up to 2 min per AI video/reel", "Voice recording + AI script", "YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "1 social platform (YouTube)"],
    cta: "Get Started",
    highlighted: true,
  ...
  },
  {
    ...
    badge: null,
    features: ["12 AI videos/month", "Unlimited camera recordings (up to 30 mins)", "Built-in teleprompter", "Up to 2 min per AI video/reel", "Voice recording + AI script", "YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "Priority rendering", "1 social platform (YouTube)"],
    cta: "Get Started",
    highlighted: false,
