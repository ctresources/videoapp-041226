...
const pricingTiers = [
  {
    ...
    badge: null,
    features: ["4 AI videos/month", "Unlimited camera recordings (up to 15 mins each)", "Built-in teleprompter", "Up to 2 min per AI video/reel", "Long-form AI videos (8–15 min) — pay-as-you-go, 6 credits", "Voice recording + AI script", "AI content toolkit — title, script, description, tag & channel-name generators", "Thumbnail & YouTube channel banner generator", "YouTube (16:9) & Reel (9:16) formats", "1 social platform (YouTube)", "Other platforms coming soon"],
    cta: "Get Started",
    highlighted: false,
  ...
  },
  {
    ...
    badge: "Most Popular",
    features: ["8 AI videos/month", "Unlimited camera recordings (up to 15 mins each)", "Built-in teleprompter", "Up to 2 min per AI video/reel", "Long-form AI videos (8–15 min) — pay-as-you-go, 6 credits", "Voice recording + AI script", "AI content toolkit — title, script, description, tag & channel-name generators", "Thumbnail & YouTube channel banner generator", "YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "1 social platform (YouTube)", "Other platforms coming soon"],
    cta: "Get Started",
    highlighted: true,
  ...
  },
  {
    ...
    badge: null,
    features: ["12 AI videos/month", "Long-form AI videos (8–15 min, mid-roll ad ready) included — 6 credits each", "Unlimited camera recordings (up to 15 mins each)", "Built-in teleprompter", "Up to 2 min per AI video/reel", "Voice recording + AI script", "AI content toolkit — title, script, description, tag & channel-name generators", "Thumbnail & YouTube channel banner generator", "YouTube (16:9) & Reel (9:16) formats", "MLS listing auto-video", "Priority rendering", "1 social platform (YouTube)", "Other platforms coming soon"],
    cta: "Get Started",
    highlighted: false,
